...
import javax.swing.*;
public class fs17 extends JFrame implements ItemListener,ActionListener {
...
setLayout(null);
i1=new ImageIcon("images//t1.jfif");
i2=new ImageIcon("images//t2.jfif");
i3=new ImageIcon("images//t3.jfif");
i4=new ImageIcon("images//t4.jfif");
i5=new ImageIcon("images//t5.jfif");
i6=new ImageIcon("images//t6.jfif");
i7=new ImageIcon("images//t7.jfif");
l1=new JLabel(i1);
l2=new JLabel(i2);
l3=new JLabel(i3);
l4=new JLabel(i4);
...
c1=new JCheckBox("Tandoori Grilled Paneer(129/-)");
c2=new JCheckBox("Assorted Grill Veg(155/-)");
c3=new JCheckBox("Crispy Masala Corn(99/-)");
c4=new JCheckBox("Palak Chaat(110/-)");
c5=new JCheckBox("Softy Masticate Soya(169/-)");
c6=new JCheckBox("Cajun Spice Potato(135/-)");
c7=new JCheckBox("Veg Soup(145/-)");
