...
import javax.swing.*;
public class fs11 extends JFrame implements ItemListener,ActionListener {
...
setLayout(null);
i1=new ImageIcon("images//sb1.jfif");
i2=new ImageIcon("images//sb2.jfif");
i3=new ImageIcon("images//sb3.jfif");
i4=new ImageIcon("images//sb4.jfif");
i5=new ImageIcon("images//sb5.jfif");
i6=new ImageIcon("images//sb6.jfif");
i7=new ImageIcon("images//sb7.jfif");
l1=new JLabel(i1);
l2=new JLabel(i2);
l3=new JLabel(i3);
l4=new JLabel(i4);
...
c1=new JCheckBox("Aloo Patty(125/-)");
c2=new JCheckBox("Chatpata Chana Patty(110/-)");
c3=new JCheckBox("Corn & Peas(125/-)");
c4=new JCheckBox("Hara bhara Kebab(110/-)");
c5=new JCheckBox("Panner Tikka(125/-)");
c6=new JCheckBox("Mexican Patty(110/-)");
c7=new JCheckBox("Veg Shammi Kebab(125/-)");
