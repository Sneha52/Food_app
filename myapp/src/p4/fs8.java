...
import javax.swing.*;
public class fs8 extends JFrame implements ItemListener,ActionListener {
...
setLayout(null);
i1=new ImageIcon("images//d1.jfif");
i2=new ImageIcon("images//d2.jfif");
i3=new ImageIcon("images//d3.jfif");
i4=new ImageIcon("images//d4.jfif");
i5=new ImageIcon("images//d5.jfif");
i6=new ImageIcon("images//d6.jfif");
i7=new ImageIcon("images//d7.jfif");
l1=new JLabel(i1);
l2=new JLabel(i2);
l3=new JLabel(i3);
l4=new JLabel(i4);
...
c1=new JCheckBox("Pepper Barbecue(335/-) ");
c2=new JCheckBox("Chicken Sausage(305/-)");
c3=new JCheckBox("Golden Delight(450/-)");
c4=new JCheckBox("Supreme(570/-)");
c5=new JCheckBox("Dominator(570/-)");
c6=new JCheckBox("Pepper Barbecue & Onion(395/-)");
c7=new JCheckBox("Fiesta(450/-)");
...
c6.setFont(new Font("Arial", Font.BOLD, 10));
