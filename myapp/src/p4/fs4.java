...
import javax.swing.*;
public class fs4 extends JFrame implements ItemListener,ActionListener {
...
setLayout(null);
i1=new ImageIcon("images//mc1.jfif");
i2=new ImageIcon("images//mc2.jpg");
i3=new ImageIcon("images//mc8.jfif");
i4=new ImageIcon("images//mc4.jpg");
i5=new ImageIcon("images//mc5.jpg");
i6=new ImageIcon("images//mc6.jpg");
i7=new ImageIcon("images//mc7.png");
...
c1=new JCheckBox("Maharaja Burger(145/-)");
c2=new JCheckBox("Mc veggie(75/-)");
c3=new JCheckBox("Mc spicy paneer(128/-)");
c4=new JCheckBox("Mc Aloo tikki(32/-)");
c5=new JCheckBox("French Fries(75/-)");
c6=new JCheckBox("Coke(30/-)");
c7=new JCheckBox("Mc Puff(35/-)");
