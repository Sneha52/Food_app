...
import javax.swing.*;
public class fs18 extends JFrame implements ItemListener,ActionListener {
...
setLayout(null);
i1=new ImageIcon("images//n1.jfif");
i2=new ImageIcon("images//n2.jfif");
i3=new ImageIcon("images//n3.jfif");
i4=new ImageIcon("images//n4.jfif");
i5=new ImageIcon("images//n5.jfif");
i6=new ImageIcon("images//n6.jfif");
i7=new ImageIcon("images//n7.jfif");
l1=new JLabel(i1);
l2=new JLabel(i2);
l3=new JLabel(i3);
l4=new JLabel(i4);
...
c1=new JCheckBox("Grilled Prawns(250/-)");
c2=new JCheckBox("Roasted Wings(399/-)");
c3=new JCheckBox("Tandoori Tangri(299/-)");
c4=new JCheckBox("Grilled Basa(269/-)");
c5=new JCheckBox("Lamb Seekh(179/-)");
c6=new JCheckBox("Chicken Tikka(399/-)");
c7=new JCheckBox("Non Veg Soup(400/-)");
