...
import javax.swing.*;
public class fs7 extends JFrame implements ItemListener,ActionListener {
...
setLayout(null);
i1=new ImageIcon("images//dm1.jfif");
i2=new ImageIcon("images//dm2.jfif");
i3=new ImageIcon("images//dm3.jfif");
i4=new ImageIcon("images//dm4.jfif");
i5=new ImageIcon("images//dm5.jfif");
i6=new ImageIcon("images//dm6.jfif");
i7=new ImageIcon("images//dm7.jfif");
l1=new JLabel(i1);
l2=new JLabel(i2);
l3=new JLabel(i3);
l4=new JLabel(i4);
...
c1=new JCheckBox("Margherita(199/-)");
c2=new JCheckBox("Farm House(385/-)");
c3=new JCheckBox("Peppy Paneer(385/-)");
c4=new JCheckBox(" Green Wave(385/-)");
c5=new JCheckBox("Deluxe Veggie(450/-)");
c6=new JCheckBox("Veg Extravaganza(450/-)");
c7=new JCheckBox("Cheese & Corn(305/-)");
