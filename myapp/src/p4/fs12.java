...
import javax.swing.*;
public class fs12 extends JFrame implements ItemListener,ActionListener {
...
setLayout(null);
i1=new ImageIcon("images//s1.jfif");
i2=new ImageIcon("images//s2.jfif");
i3=new ImageIcon("images//s3.jfif");
i4=new ImageIcon("images//s4.jfif");
i5=new ImageIcon("images//s5.jfif");
i6=new ImageIcon("images//s6.jfif");
i7=new ImageIcon("images//s7.jfif");
l1=new JLabel(i1);
l2=new JLabel(i2);
l3=new JLabel(i3);
l4=new JLabel(i4);
...
c1=new JCheckBox("Chicken Kofta(150/-)");
c2=new JCheckBox("Chicken Slices(150/-)");
c3=new JCheckBox("Chicken Tandoori(135/-)");
c4=new JCheckBox("Chicken Teriyaki(150/-)");
c5=new JCheckBox("Chicken Tikka(135/-)");
c6=new JCheckBox("Oven Roasted Chicken(135/-)");
c7=new JCheckBox("Turkey(150/-)");
